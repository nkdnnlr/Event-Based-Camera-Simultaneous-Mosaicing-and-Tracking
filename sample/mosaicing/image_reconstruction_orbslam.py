...
filename_events = os.path.join(data_dir, 'poses_orb.txt')
poses = pd.read_csv(filename_events, delimiter=' ', header=None, names=['sec', 'x', 'y', 'z', 'qx', 'qy', 'qz', 'qw'])
num_poses = poses.size
print("Number of poses in file: ", num_poses)

poses['t'] = poses['sec'] #time_ctrl in MATLAB
