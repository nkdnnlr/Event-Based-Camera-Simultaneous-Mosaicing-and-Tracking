            ...
            if got_stamp:
                if first_msg:
                    ...
                    if stamp < reset_time:
                        reset_time = stamp
    print
    "Reset time: " + timestamp_str(reset_time)
...
"All data extracted!"
print
"Events:       " + str(event_sum)
print
"Images:       " + str(image_index)
print
"Depth maps:   " + str(depthmap_index)
print
"IMU:          " + str(imu_msg_sum)
print
"Ground truth: " + str(groundtruth_msg_sum)
...
if groundtruth_msg_sum == 0:
    ...
    print
    "Removed ground truth file since there were no messages."
